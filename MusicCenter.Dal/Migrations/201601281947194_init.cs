namespace MusicCenter.Dal.Migrations
{
    ...
    public partial class init : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BandMemberConcert", "ConcertID", "dbo.Band");
            DropForeignKey("dbo.BandMemberConcert", "BandID", "dbo.Concert");
            ...
            DropIndex("dbo.BandMemberConcert", new[] { "ConcertID" });
            DropIndex("dbo.BandMemberConcert", new[] { "BandID" });
            ...
            DropTable("dbo.BandMemberConcert");
